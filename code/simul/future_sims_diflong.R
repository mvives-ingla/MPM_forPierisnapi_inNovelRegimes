...
## Simulations with varying juvenile and adult longevities
...
## To simulate a transition matrix by bootstraping from survival, eclosion and fecundity data with varying longevity
source("code/simul/functions/simul_matrix_long.R")
...
sims_future <- expand_grid(site = c("lowl", "mide"),
...
save(sims_future, file = paste0("data/mpm/sims_output/boot/sims_future_drought_diflong",
